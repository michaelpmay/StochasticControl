classdef ModelFactory
  ...
  properties
    ...
    fullKammashModelParameterSet=[40.3453e-003     1.8490e-003     4.8568e+000     9.8732e+006     2.7501e+000   195.7343e-003     1.6808e+003]
  ...
  methods
    ...
    function model=khammashFullModel(obj)
      ...
      model.rxnRate=@(t,x,p)[p(1);p(2);p(3)*x(1)*x(2);
        p(4)*x(3);
        p(5)*x(3)*(1-x(4));
        p(6)*x(4);
        p(7)*x(4);
        obj.ga*x(5)];
      model.initialState=[30;10;0;0;0]
      model.time=obj.time;
    end
    function model=khammashFullModelWithLightInput(obj)
      model=obj.khammashFullModel
      input=@(t,x)obj.ExperimentalInput(t,x,obj.eu);
